...
class X86ISA_COLONS_IntelMP_COLONS_IOAPIC(m5.internal.param_X86IntelMPBaseConfigEntry.X86ISA_COLONS_IntelMP_COLONS_BaseConfigEntry):
...
class X86IntelMPIOAPICParams(m5.internal.param_X86IntelMPBaseConfigEntry.X86IntelMPBaseConfigEntryParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def create(self):
        return _param_X86IntelMPIOAPIC.X86IntelMPIOAPICParams_create(self)
