%module(package="m5.internal") param_X86IntelMPLocalIntAssignment
...
%rename(X86ISA_COLONS_IntelMP_COLONS_LocalIntAssignment) LocalIntAssignment;

// stop swig from creating/wrapping default ctor/dtor
%nodefault LocalIntAssignment;
