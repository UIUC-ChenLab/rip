...
struct LoopAttributes {
  ...
  //wei : identify whether this is a critical loop
  bool IsCritical;
...
public:
  ...
  //wei
  bool getCurLoopCritical() const {
    return hasInfo()? getInfo().getAttributes().IsCritical : false;
  }

  //wei
  void setCritical(bool Critical = true) {StagedAttrs.IsCritical = Critical; }
